...
import kr.openbase.adcsmart.web.report.inspection.alteon.parser.TemperatureInfoParser;
...
public class TemperatureInfoRow extends AbstractRow
{
    ...
    public TemperatureInfoRow(final String swVersion, final AlteonDataHandler dataHandler, final String model)
    {
    ...
    public OBDtoInspectionReportRow getRow(final Column col) throws OBException
    {
        ...
        reportRowDto.setInspectionlist(OBMessages.getMessage(OBMessages.MSG_RPT_BASIC_TEMP_STATE));
        reportRowDto.setCheckMethod("/info/sys/temp");

        try
        {
            final String commandResult = dataHandler.getSysTemp();
            final List<String> tempValueAndStatus = new TemperatureInfoParser(swVersion, modelNumber).parse(commandResult);

//            System.out.println("parsedResult : " + tempValueAndStatus);
            reportRowDto.setChecklist(tempValueAndStatus.get(0));
//            reportRowDto.setChecklist(parsedResult.toString());
            reportRowDto.setResult(tempValueAndStatus.get(1));
        }
        catch(Exception e)
        {
...
//            System.out.println("parsedString : " + parsedString);
            ...
            List<String> temperatureString = new ArrayList<>();
            ...
            if(parsedString.size() == 2 && parsedString.get(1) != null)
            {
                for(int i = 0; i < parsedString.size(); i++)
                {
                    ...
                    temperatureString.add(parsedString.get(i));                    
                }
...
//            }
    ...
    class UpperSeriesModel implements SeriesModel
    {
        ...
        {
//            System.out.println("parsedString:" + parsedString);
//            parsedString:[1(59℃), 2(79℃), 3(39℃),  Current device temperature is OK  ]
//            System.out.println(parsedString.size());
//            System.out.println(parsedString.get(0));
//            System.out.println(parsedString.get(1));
