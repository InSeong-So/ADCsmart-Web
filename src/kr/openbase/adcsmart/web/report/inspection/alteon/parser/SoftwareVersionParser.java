...
public class SoftwareVersionParser extends AbstractAlteonParser {
	...
	public List<String> parse(String input) {
		final List<String> softwareVersion = new ArrayList<String>();

		Matcher match = getMatcher("Software Version\\s+([\\d\\.]+)\\s+", input);

		if (match.find()) {
			softwareVersion.add(match.group(1));
		}
