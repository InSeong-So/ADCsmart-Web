 ...
 */
package kr.openbase.adcsmart.web.telnet;
...
//    private static int __FIRST_OPTION = BINARY;
	...
	/***
	 * Returns the string representation of the telnet protocol option corresponding
	 * to the given option code.
	 * <p>
	 * 
	...
	/***
	 * Determines if a given option code is valid. Returns true if valid, false if
	 * not.
	 * <p>
	 * 
