...
//	private Integer adcIndex=0;
	...
	private Integer trackVrs=0;
	private Integer trackPorts=0;
	private Integer trackInt=0;
	private Integer trackL4pts=0;
	private Integer trackReals=0;
	private Integer trackHsrp=0;
	private Integer trackHsrv=0;
	private Integer sharing=0;
	
	public static VrrpInfoDto toVrrpInfoDto(OBDtoVrrpInfo vrrpInfoFromSvc) {
		VrrpInfoDto vrrpInfo = new VrrpInfoDto();
		vrrpInfo.setAdcIndex(vrrpInfoFromSvc.getAdcIndex());
//		vrrpInfo.setAdcIndex((int)vrrpInfoFromSvc.getAdcIndex());
	...
	{
		return "vrrpInfoDto [adcIndex=" + adcIndex + ", syncStatus="
