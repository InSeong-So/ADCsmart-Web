...
public class AdcPASKHealthCheckDto
{
	...
	public static AdcPASKHealthCheckDto toAdcPASKHealthCheckDto(OBDtoAdcHealthCheckPASK healthFromSvc)
	{
		if (healthFromSvc == null)
		{
			return null;
		}
		AdcPASKHealthCheckDto health = new AdcPASKHealthCheckDto();
	...
	public static List<AdcPASKHealthCheckDto> toAdcPASKHealthCheckDto(List<OBDtoAdcHealthCheckPASK> healthsFromSvc)
	{
		ArrayList<AdcPASKHealthCheckDto> healths = new ArrayList<AdcPASKHealthCheckDto>();
		for (OBDtoAdcHealthCheckPASK e : healthsFromSvc)
		{
			healths.add(toAdcPASKHealthCheckDto(e));
		}
		return healths;
	}
	
	public static OBDtoAdcHealthCheckPASK toOBDtoAdcHealthCheckPASK(AdcPASKHealthCheckDto health)
	{
		if (health == null || health.getId() == null) //사실상 health가 null인 경우는 없고, 선택 안 하면 NONE(지정안함)인데, 그러면 null로 줘서 없음을 표시한다.
		{											  // PASK 는 type 이 아닌 id 를 보내기 때문에, 지정안함을 id = null 로 처리한다.
			return null;
		}
		OBDtoAdcHealthCheckPASK healthFromSvc = new OBDtoAdcHealthCheckPASK();
	...
	public String toString() {
		return "AdcPASKHealthCheckDto [dbIndex=" + dbIndex + ", id=" + id
