...
public class OBDtoVLanInfoPASK
{
	private 	String name		="";
	private		int		id		=0;
	...
	{
		return "OBDtoVLanInfoPASK [name=" + name + ", id=" + id + ", status=" + status + ", taggedPortList=" + taggedPortList + ", untaggedPortList=" + untaggedPortList + ", unavailabledPortList=" + unavailabledPortList + "]";
	}
