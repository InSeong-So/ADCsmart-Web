...
public class OBDtoResourceInfoPAS
{
	...
	{
		return "OBDtoResourceInfoPAS [cpuUsageMP=" + cpuUsageMP
				+ ", cpuUsageSP=" + cpuUsageSP + ", totalMemMP=" + totalMemMP
				+ ", totalMemSP=" + totalMemSP + ", usedMemMP=" + usedMemMP
				+ ", freeMemMP=" + freeMemMP + ", memUsageMP=" + memUsageMP
				+ ", usedMemSP=" + usedMemSP + ", freeMemSP=" + freeMemSP
				+ ", memUsageSP=" + memUsageSP + "]";
	}
