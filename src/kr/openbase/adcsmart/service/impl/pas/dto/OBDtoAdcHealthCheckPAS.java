...
public class OBDtoAdcHealthCheckPAS implements Serializable
{
	...
	{
		return "OBDtoAdcHealthCheckPAS [dbIndex=" + dbIndex + ", id=" + id
				+ ", name=" + name + ", type=" + type + ", port=" + port
				+ ", interval=" + interval + ", timeout=" + timeout
				+ ", state=" + state + "]";
	}
	
	public OBDtoAdcHealthCheckPAS()
	{
	}

	public OBDtoAdcHealthCheckPAS(OBDtoAdcHealthCheckPAS obj)
	{
		if(obj!=null)
		{
