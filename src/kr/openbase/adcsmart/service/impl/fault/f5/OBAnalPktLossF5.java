...
public class OBAnalPktLossF5
{
	...
	public String getTcpFlagInfo(OBDtoFaultCheckPacketLossInfo pktInfo)
	{
		switch(pktInfo.getTcpFlag())
		{
		case OBDefine.TH_SYN:
	...
	public static final  int	MAX_LOSS_PKT_COUNT		=100;
	
	public OBDtoPktLossInfo analyzePacketLoss(String clientIPAddress, String vsIPAddress, ArrayList<String>realIPAddrList, ArrayList<OBDtoFaultCheckPacketLossInfo> readInfoList) throws OBException
	{// alteon은 sequecnce 번호가 같음.
		...
		{// 현재 입력받은 패킷의 다음 패킷이 있는지 검사한다.
			if(prevInfo!=null)
			{
				...
				pktInfo.setTimeDiff(timeDiff); //milisecond 단위
			}
			prevInfo = pktInfo;
