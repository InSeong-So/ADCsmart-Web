 ...
 */
public class OBCLIParserAlteonV28 extends OBCLIParserAlteon {
	private final static String SUFFIX_MORE = "any other key to continue[0m";

	public OBCLIParserAlteonV28() {
	}
...
//			System.out.println(new OBCLIParserAlteonV28().parseSeesionDumpList(1,cfgDump, -1, "SLB")); //-1:세션 결과수 제한 없음
//			handler.disconnect();
//			System.out.println("logout OK");
//		}
//		catch(Exception e)
