...
public class OBAdcThreadPoolDone
{
	/**
	 ...
	 * This prevents this object from falsely reporting that the ThreadPool is done, just because the first thread has not yet started.
	 */
