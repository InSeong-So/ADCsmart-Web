...
public class OBDtoAdcConfigHistoryPASK
{
	private Integer	adcIndex;
	private String	vsIndex;
	private boolean		isRecoverable; 
	
	private OBDtoAdcConfigInfoPASK vsConfigInfoOld;
	private OBDtoAdcConfigInfoPASK vsConfigInfoNew;
	...
	{
		return "OBDtoAdcConfigHistoryPASK [adcIndex=" + adcIndex + ", vsIndex=" + vsIndex + ", isRecoverable=" + isRecoverable + ", vsConfigInfoOld=" + vsConfigInfoOld + ", vsConfigInfoNew=" + vsConfigInfoNew + ", vsHistoryList=" + vsHistoryList + "]";
	}
	...
	public OBDtoAdcConfigInfoPASK getVsConfigInfoOld()
	{
		return vsConfigInfoOld;
	}
	public void setVsConfigInfoOld(OBDtoAdcConfigInfoPASK vsConfigInfoOld)
	{
		this.vsConfigInfoOld = vsConfigInfoOld;
	}
	public OBDtoAdcConfigInfoPASK getVsConfigInfoNew()
	{
		return vsConfigInfoNew;
	}
	public void setVsConfigInfoNew(OBDtoAdcConfigInfoPASK vsConfigInfoNew)
	{
