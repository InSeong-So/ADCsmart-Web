...
public class OBDtoTrafficMapVService
{
	...
	{
		return "OBDtoTrafficMapVService [occurTime=" + occurTime + ", vsIndex="
				+ vsIndex + ", vsName=" + vsName + ", vsIPAddress="
				+ vsIPAddress + ", srvPort=" + srvPort + ", bpsIn=" + bpsIn
				+ ", bpsOut=" + bpsOut + ", bpsTot=" + bpsTot + ", ppsIn="
				+ ppsIn + ", ppsOut=" + ppsOut + ", ppsTot=" + ppsTot
				+ ", curConns=" + curConns + ", maxConns=" + maxConns
				+ ", totConns=" + totConns + ", status=" + status
				+ ", dispName=" + dispName + ", getDispName()=" + getDispName()
				+ ", getOccurTime()=" + getOccurTime() + ", getVsIndex()="
				+ getVsIndex() + ", getVsName()=" + getVsName()
				+ ", getVsIPAddress()=" + getVsIPAddress() + ", getSrvPort()="
				+ getSrvPort() + ", getBpsIn()=" + getBpsIn()
				+ ", getBpsOut()=" + getBpsOut() + ", getBpsTot()="
				+ getBpsTot() + ", getPpsIn()=" + getPpsIn() + ", getPpsOut()="
				+ getPpsOut() + ", getPpsTot()=" + getPpsTot()
				+ ", getCurConns()=" + getCurConns() + ", getMaxConns()="
				+ getMaxConns() + ", getTotConns()=" + getTotConns()
