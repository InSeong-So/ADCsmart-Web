...
public class OBDtoNetworkMapBackup
{
	...
	{
		return "OBDtoNetworkMapBackup [bakType=" + bakType + ", ipAddress=" + ipAddress + ", nodeIndex=" + nodeIndex 
				+ ", idType=" + idType + ", poolIndex=" + poolIndex + ", port=" + port + ", status=" + status + "]";
	}
