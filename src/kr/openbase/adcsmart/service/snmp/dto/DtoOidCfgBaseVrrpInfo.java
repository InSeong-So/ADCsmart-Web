...
public class DtoOidCfgBaseVrrpInfo
{
	...
	{
		return "DtoOidCfgVrrp [vrrpPriority=" + vrrpPriority + ", vrrpShare="
				+ vrrpShare + ", vrrpTrackVrs=" + vrrpTrackVrs
				+ ", vrrpTrackIfs=" + vrrpTrackIfs + ", vrrpTrackPorts="
				+ vrrpTrackPorts + ", vrrpTrackL4pts=" + vrrpTrackL4pts
				+ ", vrrpTrackReals=" + vrrpTrackReals + ", vrrpTrackHsrp="
				+ vrrpTrackHsrp + ", vrrpTrackHsrv=" + vrrpTrackHsrv
				+ ", vrrpState=" + vrrpState + "]";
	}
