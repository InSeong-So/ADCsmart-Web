...
//				_fillScrollbar = $('<div class="headtable ui-state-default" style="margin-right : 0px;"></div>');
				_fillScrollbar = $('<div class="headtable ui-state-default" style="margin-right: 17px;"></div>');
			...
			function buildColgroup (nbcol) {
				...
				if (options.colratio.length == 0) {
					...
					if (options.colratio.length == nbcol) {
						...
						if (options.colratio.length == nbcol+1) {
			...
			function buildHeaders(table) {
				_headers = $('<table class="head" id='+$(table).attr('id')+"Head"+'/>').append(_colgroup).append($('thead', table));
...
//				_body = $('<div class="body ui-widget-content"></div>').insertBefore(table).append(table);
				_body = $('<div class="body ui-widget-content" style="overflow-x: scroll; overflow-y: scroll;  height: 150px;"></div>').insertBefore(table).append(table);
				
				if(options.height != null &&  !isNaN(parseInt(options.height))) {
					
					/*_body.css('height', options.height + 'px');*/
					/*_body.css('height', options.height + 'px'),*/
					/*_body.css('border-bottom', '1px solid #b5b5b5');*/
				}
...
//				var tampon = _wrapper.wrap('<div class="ui-widget ui-widget-content ui-corner-all" style="font-size : 1em; "></div>').parent();
				var tampon = _wrapper.wrap('<div class="ui-widget ui-widget-content ui-corner-all"></div>').parent();
