		...
		<th>
			<span class="css_textCursor">
				<#if orderDir == 2 && orderType == 11>		
					<a class="orderDir_Desc">${LANGCODEMAP["MSG_VSF5_TABLELAST_SET_TIME"]!}
						<img src="imgs/Desc.gif"/>
						<span class="none orderType">11</span>
						<span class="none orderDir">1</span>					
					</a>						
				<#elseif orderDir == 1 && orderType == 11>	
					<a class="orderDir_Asc">${LANGCODEMAP["MSG_VSF5_TABLELAST_SET_TIME"]!}
						<img src="imgs/Asc.gif"/>
						<span class="none orderType">11</span>
						<span class="none orderDir">2</span>		
					</a>
				<#else>
					<a class="orderDir_None">${LANGCODEMAP["MSG_VSF5_TABLELAST_SET_TIME"]!}
						<img src="imgs/none.gif"/>
						<span class="none orderType">11</span>
						<span class="none orderDir">2</span>		
					</a>
	...
	<tr class="ContentsLine1 virtualServerList">
		...
		<td class="align_center">
			<#if (theVirtualServer.status!'') == 'block'>
				<img class="imgOn status_imgon" src="imgs/icon/icon_2d_3.png" alt="${LANGCODEMAP["MSG_VSF5_TABLEACTION"]!}" />
			<#elseif (theVirtualServer.status!'') == 'disable'>
				<img class="imgOn status_imgon" src="imgs/icon/icon_vs_disabled.png"  alt="${LANGCODEMAP["MSG_VSF5_TABLEACTION"]!}" />
			<#elseif (theVirtualServer.status!'') == 'available'>
				<img class="imgOn status_imgon" src="imgs/icon/icon_vs_conn.png" alt="${LANGCODEMAP["MSG_VSF5_TABLEACTION"]!}" />
			<#else>
				<img class="imgOn status_imgon" src="imgs/icon/icon_vs_disconn.png" alt="${LANGCODEMAP["MSG_VSF5_TABLEACTION"]!}" />
			</#if>
			<img class="imgOff status_imgoff none" src="imgs/icon/icon_vs_disabled.png"  alt="${LANGCODEMAP["MSG_VSF5_TABLEACTION"]!}" />
		</td>
		<td class="align_left_P10"><a id="mar_lft5" class="modifyVirtualServerLnk" href="#">${theVirtualServer.virtualIp}</a></td>
		<td class="align_center">${theVirtualServer.servicePort}</td>
		<td class="align_left_P10 textOver" title="${theVirtualServer.name}"><a class="modifyVirtualServerLnk " id="mar_lft5" href="#" target="_self">${theVirtualServer.name}</a></td>		
		...
		<td class="align_center">
			...
			<span class="position_R1L1">	
				<a href="#" class="onGoToSchedule">
					<img src="imgs/btn/btn_clock_on.png" alt="${LANGCODEMAP["MSG_VSALTEON_TABLEMONITOR"]!}"/>
				</a>
			</span>
		</td>
	</tr>
