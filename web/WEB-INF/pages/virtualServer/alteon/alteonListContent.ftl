...
<div class="contents_area">
	<div>
		<img src="imgs/title${img_lang!""}/h3_slbList.gif" class="title_h3" />			
	</div>
	<div class="control_Board">
		...
		<span class="btn"> 
			<a class="searchLnk" href="#">
				<img class="imageChange" src="imgs/meun/btn_search_1.png" alt="${LANGCODEMAP["MSG_VSALTEON_SEARCH"]!}" />
			</a>
		</span>
		<span class="total01"> 
	    ...
	    <#if (accountRole == 'system') || (accountRole == 'config')>
	        <input type="button" class="imgOn addVirtualServerLnk Btn_white" value="${LANGCODEMAP["MSG_VSALTEON_LISTADD"]!}"/>   
	        <input type="button" class="imgOff none Btn_white" disabled="disabled" value="${LANGCODEMAP["MSG_VSALTEON_LISTADD"]!}"/>  	           
	    </#if>	  
		  	<input type="button" class="imgOn refreshLnk Btn_white status_imgon" value="${LANGCODEMAP["MSG_VSALTEON_LISTREFRESH"]!}"/>  
		  	<input type="button" class="imgOff none Btn_white status_imgoff" disabled="disabled" value="${LANGCODEMAP["MSG_VSALTEON_LISTREFRESH"]!}"/> 		  			
		</div>
	</div>
	<br class="clearfix" />
	...
	<table class="Board virtualSvrTable" cellpadding="0" cellspacing="0" style="table-layout: fixed;">
		<#include "virtualSvrTableInAlteonListContent.ftl"/>
	</table>
	...
	<table class="Board_97 disabledChk" border="0" >
		...
		<tr>
	  		...
	  		<#elseif accountRole != 'readOnly' && accountRole != 'rsAdmin'>  		
	  		    <input type="button" class="imgOn enableVssLnk Btn_white_small" value="Enable"/> 
	  		    <input type="button" class="imgOn disableVssLnk Btn_white_small" value="Disable"/> 
	  		    <input type="button" class="imgOn delVssLnk Btn_white_small" value="${LANGCODEMAP["MSG_VSALTEON_LISTDELETE"]!}"/> 
	  		    
	  		    <input type="button" class="imgOff none Btn_white_small" disabled="disabled" value="Enable"/> 
	  		    <input type="button" class="imgOff none Btn_white_small" disabled="disabled" value="Disable"/> 
	  		    <input type="button" class="imgOff none Btn_white_small" disabled="disabled" value="${LANGCODEMAP["MSG_VSALTEON_LISTDELETE"]!}"/> 
       		</#if>
       		</td>
       	</tr>
       	<tr>
