...
<div class="contents_area">
	...
	<div  class="control_Board">
		...
		<span class="btn"> 
			<a class="searchLnk" href="#">
				<img class="imageChange" src="imgs/meun/btn_search_1.png" alt="${LANGCODEMAP["MSG_VSPASK_LISTSEARCH"]!}" />
			</a>
		</span>
		<span class="total01"> 
	    ...
	    <#if (accountRole == 'system') || (accountRole == 'config')>
	    	<input type="button" class="imgOn addVirtualServerLnk Btn_white" value="${LANGCODEMAP["MSG_VSPASK_LISTADD"]!}"/>   
	        <input type="button" class="imgOff none Btn_white" disabled="disabled" value="${LANGCODEMAP["MSG_VSPASK_LISTADD"]!}"/>  	
	    </#if>
	        <input type="button" class="imgOn refreshLnk Btn_white status_imgon" value="${LANGCODEMAP["MSG_VSPASK_LISTREFRESH"]!}"/>  
		  	<input type="button" class="imgOff none Btn_white status_imgoff" disabled="disabled" value="${LANGCODEMAP["MSG_VSPASK_LISTREFRESH"]!}"/> 
		</div>
	</div>
	<br class="clearfix" />
	...
	<table class="Board virtualSvrTable" cellpadding="0" cellspacing="0" style="table-layout: fixed;">
		<#include "virtualSvrTableInpaskListContent.ftl"/>
	</table>
		...
		<tr>
		  	<td>
		  		...
		  		<#elseif accountRole != 'readOnly' && accountRole != 'rsAdmin'>
		         		...
		         		<input type="button" class="imgOn disableVssLnk Btn_white_small" value="Disable"/> 
		         		<input type="button" class="imgOff none Btn_white_small" disabled="disabled" value="Disable"/>
		         		<input type="button" class="imgOn delVssLnk Btn_white_small" value="${LANGCODEMAP["MSG_VSPASK_LISTDEL"]!}"/>
		         		<input type="button" class="imgOff none Btn_white_small" disabled="disabled" value="${LANGCODEMAP["MSG_VSPASK_LISTDEL"]!}"/>
		       	</#if>
	       	</td>
		</tr>
		<td></td>
