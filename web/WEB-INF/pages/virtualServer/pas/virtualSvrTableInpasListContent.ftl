		...
		<th>
			<span class="css_textCursor">
				<#if orderDir == 2 && orderType == 18>		
					<a class="orderDir_Desc">${LANGCODEMAP["MSG_VSPAS_TABLEPORT"]!}
						<img src="imgs/Desc.gif"/>
						<span class="none orderType">18</span>
						<span class="none orderDir">1</span>					
					</a>						
				<#elseif orderDir == 1 && orderType == 18>	
					<a class="orderDir_Asc">${LANGCODEMAP["MSG_VSPAS_TABLEPORT"]!}
						<img src="imgs/Asc.gif"/>
						<span class="none orderType">18</span>
						<span class="none orderDir">2</span>		
					</a>
				<#else>
					<a class="orderDir_None">${LANGCODEMAP["MSG_VSPAS_TABLEPORT"]!}
						<img src="imgs/none.gif"/>
						<span class="none orderType">18</span>
						<span class="none orderDir">2</span>		
					</a>
		...
		<th>
			<span class="css_textCursor">
				<#if orderDir == 2 && orderType == 1>		
					<a class="orderDir_Desc">${LANGCODEMAP["MSG_VSPAS_TABLENAME"]!}
						<img src="imgs/Desc.gif"/>
						<span class="none orderType">1</span>
						<span class="none orderDir">1</span>					
					</a>						
				<#elseif orderDir == 1 && orderType == 1>	
					<a class="orderDir_Asc">${LANGCODEMAP["MSG_VSPAS_TABLENAME"]!}
						<img src="imgs/Asc.gif"/>
						<span class="none orderType">1</span>
						<span class="none orderDir">2</span>		
					</a>
				<#else>
					<a class="orderDir_None">${LANGCODEMAP["MSG_VSPAS_TABLENAME"]!}
						<img src="imgs/none.gif"/>
						<span class="none orderType">1</span>
						<span class="none orderDir">2</span>		
					</a>
		...
		<th>
			<span class="css_textCursor">
				<#if orderDir == 2 && orderType == 11>		
					<a class="orderDir_Desc">${LANGCODEMAP["MSG_VSPAS_TABLELAST_SET_TIME"]!}
						<img src="imgs/Desc.gif"/>
						<span class="none orderType">11</span>
						<span class="none orderDir">1</span>					
					</a>						
				<#elseif orderDir == 1 && orderType == 11>	
					<a class="orderDir_Asc">${LANGCODEMAP["MSG_VSPAS_TABLELAST_SET_TIME"]!}
						<img src="imgs/Asc.gif"/>
						<span class="none orderType">11</span>
						<span class="none orderDir">2</span>		
					</a>
				<#else>
					<a class="orderDir_None">${LANGCODEMAP["MSG_VSPAS_TABLELAST_SET_TIME"]!}
						<img src="imgs/none.gif"/>
						<span class="none orderType">11</span>
						<span class="none orderDir">2</span>		
					</a>
	...
	<tr class="ContentsLine1 virtualServerList">
		...
		<td class="align_center">
			<#if (theVirtualServer.status!'') == 'block'>
				<img src="imgs/icon/icon_2d_3.png" alt="${LANGCODEMAP["MSG_VSPAS_TABLEACTION"]!}" />
			<#elseif (theVirtualServer.status!'') == 'disable'>
				<img src="imgs/icon/icon_vs_disabled.png"  alt="${LANGCODEMAP["MSG_VSPAS_TABLEACTION"]!}" />
			<#elseif (theVirtualServer.status!'') == 'available'>
				<img src="imgs/icon/icon_vs_conn.png" alt="${LANGCODEMAP["MSG_VSPAS_TABLEACTION"]!}" />
			<#else>
				<img src="imgs/icon/icon_vs_disconn.png" alt="${LANGCODEMAP["MSG_VSPAS_TABLEACTION"]!}" />
			</#if>
		</td>
		<td class="align_left_P10">
			<a id="mar_lft5" class="modifyVirtualServerLnk" href="#">${theVirtualServer.virtualIp}</a>
		</td>
		<td class="align_center">${theVirtualServer.servicePort?replace("999", ", ")}</td>
