...
<div class="portlet-content" style="overflow-x: hidden; overflow-y: auto; height: 210px;">	
	<#list dashFaultStatus.logList![] as logInfo>	
		<#if logInfo.dateChk == true> 
			<div class="widget_div_fault_1" title="${logInfo.content!}" >
		<#else>
			<div class="widget_div_fault_2" title="${logInfo.content!}" >
		</#if>
			<P>
				${logInfo.occurred!""}</br>
				${logInfo.content!""}
