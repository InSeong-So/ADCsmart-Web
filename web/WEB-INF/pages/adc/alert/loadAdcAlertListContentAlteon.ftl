...
<div class="contents_area">
	...
	<div>
		<img src="imgs/title${img_lang!""}/h3_loadAdcAlert_adc.gif" class="title_h3" />
		...
		<div class="tabs_5">
  			<span class="adc_left"></span>
	   		<span class="adc">
	   			<img src="imgs/icon/adc/icon_alteon_sW.png">&nbsp; ${adcObject.name}	
	   		</span> 
	  		<span class="adc_right"></span>	   		
	   		<span class="radio">
			<#if (alarmConfig.configLevel) == 0>
				<input type="radio" name="alarmConfigs.configLevel" class="configCngBtn" id="configLevelAll" value="0" checked="checked"/>
				<label for="configLevelAll">${LANGCODEMAP["MSG_ALERT_ALL"]!}</label>&nbsp;&nbsp;
				<input type="radio" name="alarmConfigs.configLevel" class="configCngBtn" id="configLevelGroup" value="1"/>
				<label for="configLevelGroup">${LANGCODEMAP["MSG_ALERT_GROUP"]!}</label>&nbsp;&nbsp;
				<input type="radio" name="alarmConfigs.configLevel" class="configCngBtn" id="configLevelAdc" value="2"/>
				<label for="configLevelAdc">${LANGCODEMAP["MSG_ALERT_ONE"]!}</label>
			<#elseif (alarmConfig.configLevel) == 1>
				<input type="radio" name="alarmConfigs.configLevel" class="configCngBtn" id="configLevelAll" value="0"/>
				<label for="configLevelAll">${LANGCODEMAP["MSG_ALERT_ALL"]!}</label>&nbsp;&nbsp;
				<input type="radio" name="alarmConfigs.configLevel" class="configCngBtn" id="configLevelGroup" value="1" checked="checked"/>
				<label for="configLevelGroup">${LANGCODEMAP["MSG_ALERT_GROUP"]!}</label>&nbsp;&nbsp;
				<input type="radio" name="alarmConfigs.configLevel" class="configCngBtn" id="configLevelAdc" value="2"/>
				<label for="configLevelAdc">${LANGCODEMAP["MSG_ALERT_ONE"]!}</label>
			<#elseif (alarmConfig.configLevel) == 2>
				<input type="radio" name="alarmConfigs.configLevel" class="configCngBtn" id="configLevelAll" value="0"/>
				<label for="configLevelAll">${LANGCODEMAP["MSG_ALERT_ALL"]!}</label>&nbsp;&nbsp;
				<input type="radio" name="alarmConfigs.configLevel" class="configCngBtn" id="configLevelGroup" value="1"/>
				<label for="configLevelGroup">${LANGCODEMAP["MSG_ALERT_GROUP"]!}</label>&nbsp;&nbsp;
				<input type="radio" name="alarmConfigs.configLevel" class="configCngBtn" id="configLevelAdc" value="2" checked="checked"/>
				<label for="configLevelAdc">${LANGCODEMAP["MSG_ALERT_ONE"]!}</label>
			<#else>
			</#if>
	   		</span> 				
...
<br class="clearfix">
	...
	<table class="Board_conn" cellpadding="0" cellspacing="0">
		...
		<tr>			
            ...
            <th><input class="allSMSChk" type="checkbox" name="checkbox" id="checkbox" disabled="disabled">&nbsp;SMS대응</th>
		</tr>
		</thead>		
		<tbody>
		<tr>
            ...
            <td>
                ...
                <#else>
                    ...
                    <input type="hidden" id="adcDisconnectAction_sms_h" name="alarmConfigs.adcDisconnectAction.sms" value="${(alarmConfig.adcDisconnectAction.sms)}" />
            </td>           
		</tr>
		<tr>
	...
	<table class="Board_conn" cellpadding="0" cellspacing="0">
		...
		<tr>
			...
			<th class="Rcolor"><input class="allEnableChk1" type="checkbox" name="checkbox" id="checkbox">&nbsp;${LANGCODEMAP["MSG_ALERT_SAVE"]!}</th>	
			<th class="Rcolor">${LANGCODEMAP["MSG_ALERT_PERIOD"]!}</th>	
			<th class=""><input class="allSyslogChk1" type="checkbox" name="checkbox" id="checkbox" disabled="disabled">&nbsp;${LANGCODEMAP["MSG_ALERT_ACTION_SYSLOG"]!}</th>
            <th class=""><input class="allSnmpTrapChk1" type="checkbox" name="checkbox" id="checkbox" disabled="disabled">&nbsp;${LANGCODEMAP["MSG_ALERT_ACTION_SNMPTRAP"]!}</th>           
            <th class=""><input class="allSMSChk1" type="checkbox" name="checkbox" id="checkbox" disabled="disabled">&nbsp;SMS대응</th>           
		</tr>
		</thead>
		<tbody>
		<tr>
	...
	<table class="Board_conn" cellpadding="0" cellspacing="0">
		...
		<tr>
			...
			<th class="Rcolor">${LANGCODEMAP["MSG_ALERT_PERIOD"]!}</th>	
			<th class=""><input class="allSyslogChk2" type="checkbox" name="checkbox" id="checkbox" disabled="disabled">&nbsp;${LANGCODEMAP["MSG_ALERT_ACTION_SYSLOG"]!}</th>
			<th class=""><input class="allSnmpTrapChk2" type="checkbox" name="checkbox" id="checkbox" disabled="disabled">&nbsp;${LANGCODEMAP["MSG_ALERT_ACTION_SNMPTRAP"]!}</th>			
            <th class=""><input class="allSMSChk2" type="checkbox" name="checkbox" id="checkbox" disabled="disabled">&nbsp;SMS대응</th>           
		</tr>
		</thead>	
		<tbody>
		<tr>
            ...
            <td>
                ...
                <input type="hidden" id="adcUptimeAction_snmptrap_h" name="alarmConfigs.adcUptimeAction.sms" value="${(alarmConfig.adcUptimeAction.sms)}" />
            </td>       
		</tr>		
		<tr>
			<th>
            ...
            <td>
                ...
                <input type="hidden" id="adcPurchaseAction_snmptrap_h" name="alarmConfigs.adcPurchaseAction.sms" value="${(alarmConfig.adcPurchaseAction.sms)}" />
            </td>           
		</tr>			
	</tbody>									
	</table>
	...
	<table class="Board_conn" cellpadding="0" cellspacing="0">
		...
		<tr>
			<th class="Rcolor">${LANGCODEMAP["MSG_ALERT_ARTICLE"]!}</th>
			<th class="Rcolor"><input class="allEnableChk3" type="checkbox" name="checkbox" id="checkbox">&nbsp;${LANGCODEMAP["MSG_ALERT_SAVE"]!}</th>	
			<th class="Rcolor">${LANGCODEMAP["MSG_ALERT_PERIOD"]!}</th>	
			<th class=""><input class="allSyslogChk3" type="checkbox" name="checkbox" id="checkbox" disabled="disabled">&nbsp;${LANGCODEMAP["MSG_ALERT_ACTION_SYSLOG"]!}</th>
			<th class=""><input class="allSnmpTrapChk3" type="checkbox" name="checkbox" id="checkbox" disabled="disabled">&nbsp;${LANGCODEMAP["MSG_ALERT_ACTION_SNMPTRAP"]!}</th>			
            <th class=""><input class="allSMSChk3" type="checkbox" name="checkbox" id="checkbox" disabled="disabled">&nbsp;SMS대응</th>           
		</tr>
		</thead>		
		<tbody>
		<tr>
		...
		<tr>
			<th>
				${LANGCODEMAP["MSG_ALERT_SWITCH_INTERFACE_DUPLEX"]!}&nbsp;${LANGCODEMAP["MSG_ALERT_SWITCH_HALF_FULL"]!}
			</th>
			<td>
		...
		<tr>
			<th>
				${LANGCODEMAP["MSG_ALERT_ADC_SETTING_BACKUP_FAIL"]!}&nbsp;${LANGCODEMAP["MSG_ALERT_FAIL"]!}
			</th>
			<td>
		...
		<tr>
			<th>
				${LANGCODEMAP["MSG_ALERT_CPU_TEMPERATURE"]!}&nbsp;${LANGCODEMAP["MSG_ALERT_HIGH"]!}
			</th>
			<td>
		...
		<tr>
			<th>
				${LANGCODEMAP["MSG_ALERT_FAN_STATUS"]!}&nbsp;${LANGCODEMAP["MSG_ALERT_FAULTY"]!}
			</th>
			<td>
		...
		<tr>
            ...
            <td>
                ...
                <#else>
                    <input class="smsChk" id="alarmConfigs.onlyOnePowerSupplyAction.sms" id_h="onlyOnePowerSupplyAction_sms_h" type="checkbox" onchange="changeCheckbox(this);" value="0"/> 
                </#if>
