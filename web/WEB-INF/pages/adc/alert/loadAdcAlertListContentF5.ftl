	...
	<div>
		...
		<div class="tabs_5">
  			<span class="adc_left"></span>
	   		<span class="adc">
	   			<img src="imgs/icon/adc/icon_f5_sW.png">&nbsp; ${adcObject.name}
	   		</span> 
		...
		<tr>
            ...
            <td>
                <#if (alarmConfig.adcCpuAction.sms) == 1>
                    <input class="smsChk" id="alarmConfigs.adcCpuAction.sms" id_h="adcCpuAction_sms_h" type="checkbox" onchange="changeCheckbox(this);" checked="checked" value="1"/> 
                <#else>
                    <input class="smsChk" id="alarmConfigs.adcCpuAction.sms" id_h="adcCpuAction_sms_h" type="checkbox" onchange="changeCheckbox(this);" value="0"/> 
                </#if>          
                <input type="hidden" id="adcCpuAction_sms_h" name="alarmConfigs.adcCpuAction.sms" value="${(alarmConfig.adcCpuAction.sms)}" />                       
            </td>           
		</tr>				
		<tr>
			<th>
	...
	<table class="Board_conn" cellpadding="0" cellspacing="0">
		...
		<tr>
            ...
            <td>
                ...
                <input type="hidden" id="chassisTempTooHighAction_sms_h" name="alarmConfigs.chassisTempTooHighAction.sms" value="${(alarmConfig.chassisTempTooHighAction.sms)}" />
            </td>           
		</tr>
		<tr>
			<th>
