	...
	<table class="Board_conn" cellpadding="0" cellspacing="0">
		...
		<tr>
			...
			<td>
				...
				<input type="hidden" id="adcBootAction_popup_h" name="alarmConfigs.adcBootAction.syslog" value="${(alarmConfig.adcBootAction.syslog)}" />
			</td>	
			<td>
		...
		<tr>
            ...
            <td>
                ...
                <input type="hidden" id="adcStandbyAction_sms_h" name="alarmConfigs.adcStandbyAction.snmptrap" value="${(alarmConfig.adcStandbyAction.sms)}" />
            </td>           
		</tr>
		<tr>
		...
		<tr>
            ...
            <td>
                <#if (alarmConfig.linkDownAction.sms) == 1>
                    <input class="sms" id="alarmConfigs.linkDownAction.sms" id_h="linkDownAction_sms_h" type="checkbox" onchange="changeCheckbox(this);" checked="checked" value="1"/> 
                <#else>
                    <input class="sms" id="alarmConfigs.linkDownAction.sms" id_h="linkDownAction_sms_h" type="checkbox" onchange="changeCheckbox(this);" value="0"/> 
                </#if>
		...
		<tr>
            ...
            <td>
                <#if (alarmConfig.adcSPAction.sms) == 1>
                    <input class="smsChk" id="alarmConfigs.adcSPAction.snmptrap" id_h="adcSPAction_sms_h" type="checkbox" onchange="changeCheckbox(this);" checked="checked" value="1"/> 
                <#else>
                    <input class="smsChk" id="alarmConfigs.adcSPAction.snmptrap" id_h="adcSPAction_sms_h" type="checkbox" onchange="changeCheckbox(this);" value="0"/> 
                </#if>          
