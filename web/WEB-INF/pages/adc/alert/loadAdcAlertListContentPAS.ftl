	...
	<div>
		...
		<div class="tabs_5">
  			<span class="adc_left"></span>
	   		<span class="adc">
	   			<img src="imgs/icon/adc/icon_piolink_sW.png">&nbsp; ${adcObject.name}
	   		</span> 
...
<br class="clearfix">
	...
	<table class="Board_conn" cellpadding="0" cellspacing="0">
		...
		<tr>
			...
			<th class="Rcolor"><input class="allEnableChk" type="checkbox" name="checkbox" id="checkbox">&nbsp;${LANGCODEMAP["MSG_ALERT_SAVE"]!}</th>	
			<th class="Rcolor">${LANGCODEMAP["MSG_ALERT_PERIOD"]!}</th>	
			<th class=""><input class="allSyslogChk" type="checkbox" name="checkbox" id="checkbox">&nbsp;${LANGCODEMAP["MSG_ALERT_ACTION_SYSLOG"]!}</th>
			<th class=""><input class="allSnmpTrapChk" type="checkbox" name="checkbox" id="checkbox" disabled="disabled">&nbsp;${LANGCODEMAP["MSG_ALERT_ACTION_SNMPTRAP"]!}</th>			
            <th class=""><input class="allSMSChk" type="checkbox" name="checkbox" id="checkbox" disabled="disabled">&nbsp;SMS대응</th>            
		</tr>
		</thead>		
		<tbody>
		<tr>
	...
	<table class="Board_conn" cellpadding="0" cellspacing="0">
		...
		<tr>
			...
			<th>${LANGCODEMAP["MSG_ALERT_PERIOD"]!}</th>	
			<th><input class="allSyslogChk2" type="checkbox" name="checkbox" id="checkbox">${LANGCODEMAP["MSG_ALERT_ACTION_SYSLOG"]!}</th>	
			<th><input class="allSnmpTrapChk2" type="checkbox" name="checkbox" id="checkbox">${LANGCODEMAP["MSG_ALERT_ACTION_SNMPTRAP"]!}</th>		
            <th><input class="allSMSChk2" type="checkbox" name="checkbox" id="checkbox">SMS대응</th>      
		</tr>
		</thead>		
		<tbody>
		<tr>
