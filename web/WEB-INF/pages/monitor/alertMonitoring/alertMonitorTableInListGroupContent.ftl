			...
			<th>
				<span class="css_textCursor">
					<#if orderOption.orderDirection == 2 && orderOption.orderType == 35>		
						<a class="orderDir_Desc">${LANGCODEMAP["MSG_MONITOR_ALERT_ADC_NAME"]!}
							<img src="imgs/Desc.gif"/>
							<span class="none orderType">35</span>
							<span class="none orderDir">1</span>					
						</a>						
					<#elseif orderOption.orderDirection == 1 && orderOption.orderType == 35>	
						<a class="orderDir_Asc">${LANGCODEMAP["MSG_MONITOR_ALERT_ADC_NAME"]!}
							<img src="imgs/Asc.gif"/>
							<span class="none orderType">35</span>
							<span class="none orderDir">2</span>		
						</a>
					<#else>
						<a class="orderDir_None">${LANGCODEMAP["MSG_MONITOR_ALERT_ADC_NAME"]!}
							<img src="imgs/none.gif"/>
							<span class="none orderType">35</span>
							<span class="none orderDir">2</span>		
						</a>
	...
	<#list adcAlertLogList![] as adcAlertLog>
		<tr class="ContentsLine1 adcAlertLogList">	
			...
			<td class="align_left_P10 textOver">
				<!-- <a class="popuplink" href="#">${adcAlertLog.adcName!""}</a> -->		
				
				<a href="javascript:;" class="adcMonitoringLnk">
                	<span class="adcIndex" style="display:none;">${adcAlertLog.adcIndex!""}</span>
                	${adcAlertLog.adcName!""}
                </a>	
			</td>
			<td class="align_left_P10">
				...
				<input type="hidden" class="alert-adcname" value="${adcAlertLog.adcName!''}" />
