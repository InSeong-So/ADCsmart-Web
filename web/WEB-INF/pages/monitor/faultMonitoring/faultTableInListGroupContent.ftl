...
<thead>
	...
	<tr class="ContentsHeadLine">
		...
		<th>
			<span class="css_textCursor">
				<#if orderOption.orderDirection == 2 && orderOption.orderType == 8>		
					<a class="orderDir_Desc">${LANGCODEMAP["MSG_FAULT_ADC_NAME"]!}
						<img src="imgs/Desc.gif"/>
						<span class="none orderType">8</span>
						<span class="none orderDir">1</span>					
					</a>						
				<#elseif orderOption.orderDirection == 1 && orderOption.orderType == 8>	
					<a class="orderDir_Asc">${LANGCODEMAP["MSG_FAULT_ADC_NAME"]!}
						<img src="imgs/Asc.gif"/>
						<span class="none orderType">8</span>
						<span class="none orderDir">2</span>		
					</a>
				<#else>
					<a class="orderDir_None">${LANGCODEMAP["MSG_FAULT_ADC_NAME"]!}
						<img src="imgs/none.gif"/>
						<span class="none orderType">8</span>
						<span class="none orderDir">2</span>		
					</a>
...
<tbody>
	...
	<tr class="ContentsLine3 faultLogList">
		...
		<td class="align_left_P10 textOver">
			<!-- <a class="fault-popuplink" href="#">${adcSystemLog.adcName!""}</a> -->
			
			<a href="javascript:;" class="adcMonitoringLnk">
            	<span class="adcIndex" style="display:none;">${adcSystemLog.adcIndex!""}</span>
            	${adcSystemLog.adcName!""}
            </a>
		</td>
