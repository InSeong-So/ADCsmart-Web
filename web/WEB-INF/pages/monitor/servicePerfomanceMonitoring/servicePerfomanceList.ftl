<#if orderOption.orderType??>
	...
	<#if 38 == orderOption.orderType></#if><!-- bps_in -->
	<#if 39 == orderOption.orderType></#if><!-- bps_out -->
	<#if 40 == orderOption.orderType></#if><!-- bps_total -->
	<#if 41 == orderOption.orderType></#if><!-- pps_in -->
	<#if 42 == orderOption.orderType></#if><!-- pps_out -->
	<#if 43 == orderOption.orderType></#if><!-- pps_total -->
...
<thead>
	<tr>				
		<td colspan="12" class="StartLine"></td>			
	</tr>
	<tr>
		<th rowspan="3" class="ContentsHeadLine bg_row2 Rcolor">${LANGCODEMAP["MSG_PERFLIST_STATUS"]!}</th>
	    <th colspan="3" class="ContentsHeadLine bg_row2 Rcolor">Virtual Server</th>
	    <th rowspan="3" class="ContentsHeadLine bg_row2 Rcolor" >
	    	<span class="css_textCursor">
	    		<#if orderOption.orderDirection == 2 && orderOption.orderType == 37>		
					<a class="orderDir_Desc">${LANGCODEMAP["MSG_PERFLIST_RESPONSE_TIME"]!}
						<span class="none orderType">37</span>
						<span class="none orderDir">1</span>
						<br>(ms) <img src="imgs/Desc.gif"/>				
					</a>						
				<#elseif orderOption.orderDirection == 1 && orderOption.orderType == 37>	
					<a class="orderDir_Asc">${LANGCODEMAP["MSG_PERFLIST_RESPONSE_TIME"]!}
						<span class="none orderType">37</span>
						<span class="none orderDir">2</span>
						<br>(ms) <img src="imgs/Asc.gif"/>		
					</a>
				<#else>
					<a class="orderDir_None">${LANGCODEMAP["MSG_PERFLIST_RESPONSE_TIME"]!}
						<span class="none orderType">37</span>
						<span class="none orderDir">2</span>
						<br>(ms) <img src="imgs/none.gif"/>	
					</a>
				</#if>
	    	</span>	    
	    </th>
		<th colspan="3" class="ContentsHeadLine Rcolor">bps</th>
		<th colspan="3" class="ContentsHeadLine Rcolor">pps</th>
    ...
    <tr>
 		<td colspan="3" class="DivideLine1 Rcolor_time"></td>	
	...
	<tr class="ContentsHeadLine1">
        ...
        <th>
	  	...
	  	<th>
			<span class="css_textCursor">
				<#if orderOption.orderDirection == 2 && orderOption.orderType == 35>		
					<a class="orderDir_Desc">${LANGCODEMAP["MSG_PERFLIST_PORT"]!}
						<img src="imgs/Desc.gif"/>
						<span class="none orderType">35</span>
						<span class="none orderDir">1</span>					
					</a>						
				<#elseif orderOption.orderDirection == 1 && orderOption.orderType == 35>	
					<a class="orderDir_Asc">${LANGCODEMAP["MSG_PERFLIST_PORT"]!}
						<img src="imgs/Asc.gif"/>
						<span class="none orderType">35</span>
						<span class="none orderDir">2</span>		
					</a>
				<#else>
					<a class="orderDir_None">${LANGCODEMAP["MSG_PERFLIST_PORT"]!}
						<img src="imgs/none.gif"/>
						<span class="none orderType">35</span>
						<span class="none orderDir">2</span>		
					</a>
	  	...
	  	<th>
	  		<span class="css_textCursor">
				<#if orderOption.orderDirection == 2 && orderOption.orderType == 41>		
					<a class="orderDir_Desc">In
						<img src="imgs/Desc.gif"/>
						<span class="none orderType">41</span>
						<span class="none orderDir">1</span>					
					</a>						
				<#elseif orderOption.orderDirection == 1 && orderOption.orderType == 41>	
					<a class="orderDir_Asc">In
						<img src="imgs/Asc.gif"/>
						<span class="none orderType">41</span>
						<span class="none orderDir">2</span>		
	  	...
	  	<th>
	  		<span class="css_textCursor">
				<#if orderOption.orderDirection == 2 && orderOption.orderType == 42>		
					<a class="orderDir_Desc">Out
						<img src="imgs/Desc.gif"/>
						<span class="none orderType">42</span>
						<span class="none orderDir">1</span>					
					</a>						
				<#elseif orderOption.orderDirection == 1 && orderOption.orderType == 42>	
					<a class="orderDir_Asc">Out
						<img src="imgs/Asc.gif"/>
						<span class="none orderType">42</span>
						<span class="none orderDir">2</span>		
	  	...
	  	<th class="Rcolor">
			<span class="css_textCursor">
				<#if orderOption.orderDirection == 2 && orderOption.orderType == 43>		
					<a class="orderDir_Desc">Total
						<img src="imgs/Desc.gif"/>
						<span class="none orderType">43</span>
						<span class="none orderDir">1</span>					
					</a>						
				<#elseif orderOption.orderDirection == 1 && orderOption.orderType == 43>	
					<a class="orderDir_Asc">Total
						<img src="imgs/Asc.gif"/>
						<span class="none orderType">43</span>
						<span class="none orderDir">2</span>		
	...
	<tr>
		<td colspan="12" class="StartLine1"></td>	
	</tr>
</thead>
		...
		<#list svcPerfInfoList as svcPerfInfo>
			...
			<tr class="ContentsLine1 servicePerformList" id="${svcPerfInfo.vsIndex}">
	    		...
	    		<td class="align_center">
	    			<span class="vsPort"><#setting number_format="0.####">${svcPerfInfo.vsPort!?replace("999", ", ")}</span>
	    		</td>
				<td class="align_left_P10 Rcolor textOver">
					<span class="vsName" title="${svcPerfInfo.name!""}">${svcPerfInfo.vsName!""}</span>			
				</td>
				...
				<td class="align_center">${svcPerfInfo.ppsIn!"-"}</td>
				<td class="align_center">${svcPerfInfo.ppsOut!"-"}</td>
				<td class="align_center Rcolor">${svcPerfInfo.ppsTotal!"-"}</td>
				<td class="align_center">${svcPerfInfo.connCurr!"-"}</td>				
			</tr>
			<tr>
				<td colspan="12" class="DivideLine1"></td>				
			</tr>
		</#list>
	</#if>
	<tr>
		<td colspan="12" class="EndLine"></td>
	</tr>
</tbody>
