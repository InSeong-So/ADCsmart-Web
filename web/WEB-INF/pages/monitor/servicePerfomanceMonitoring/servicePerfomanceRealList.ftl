<#if orderOption.orderType??>
	...
	<#if 36 == orderOption.orderType></#if><!-- bps_in -->
	<#if 37 == orderOption.orderType></#if><!-- bps_out -->
	<#if 38 == orderOption.orderType></#if><!-- bps_total -->
	<#if 39 == orderOption.orderType></#if><!-- pps_in -->
	<#if 40 == orderOption.orderType></#if><!-- pps_out -->
	<#if 41 == orderOption.orderType></#if><!-- pps_total -->
...
<thead>
	<tr>				
		<td colspan="11" class="StartLine"></td>			
	</tr>
	<tr>
	    <th colspan="4" class="ContentsHeadLine Rcolor">Virtual Server</th>
	...
	<tr>
		<td colspan="11" class="StartLine1"></td>	
	</tr>
</thead>
<tbody>
    <tr class="ContentsLine1" id="${vsTrafficInfo.vsIndex!""}" idx = "-1">
	    ...
	    <td class="align_center">
	    	<span class="vsPort"><#setting number_format="0.####">${vsTrafficInfo.port?replace("999", ", ")!0}</span>
    ...
    <td></td>	
		...
		<td class="align_center">${vsMemberTrafficInfo.port!"-"}</td>
		<td class="align_left_P10 Rcolor textOver">-</td>
