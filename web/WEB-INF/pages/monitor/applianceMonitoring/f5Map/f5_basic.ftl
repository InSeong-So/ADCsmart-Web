<div class="F5_basic">
	<#if faultHWStatus.cpuStatusList?has_content>		
		...
		<div class="cpu01 txt cGreen">
			...
			<a href="#" data-tool="${faultHWStatus.cpuNormalList?replace("]", "")?replace("[", "")}" class="tooltip bottom green">CPU:${normal}${LANGCODEMAP["MSG_LAYOUT_COUNT"]!}</a>
		</div>
		...
		<div class="cpu02 txt cRed">
			...
			<a href="#" data-tool="${faultHWStatus.cpuAbNormalList?replace("]", "")?replace("[", "")}" class="tooltip bottom red">CPU:${abNormal}${LANGCODEMAP["MSG_LAYOUT_COUNT"]!}</a>						
		</div>		
	<#else>
	...
	<table class="porttable">		
		<tr>
			<td>
			<#if !faultHWStatus.portStatusList[0].intfName?contains("mgmt")>
			...
			<#if !faultHWStatus.portStatusList[1].intfName?contains("mgmt")>
			...
			<td>
			<#if !faultHWStatus.portStatusList[2].intfName?contains("mgmt")>				
			...
			<#if !faultHWStatus.portStatusList[3].intfName?contains("mgmt")>				
			...
			<td>
			<#if !faultHWStatus.portStatusList[4].intfName?contains("mgmt")>				
			...
			<#if !faultHWStatus.portStatusList[5].intfName?contains("mgmt")>				
			...
			<td>
			<#if !faultHWStatus.portStatusList[6].intfName?contains("mgmt")>				
			...
			<#if !faultHWStatus.portStatusList[7].intfName?contains("mgmt")>				
