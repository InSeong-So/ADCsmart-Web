<#if adcInfo.adcType == 10000>
<div class="F5_10000">
<#elseif adcInfo.adcType == 10200>
<div class="F5_10200">
<#else>
<div class="F5_basic">
</#if>
	<#if faultHWStatus.cpuStatusList?has_content>
		...
		<#if faultHWStatus.cpuStatusList[8] == 1>
			<div class="cpu09 txt cGreen">CPU9</div>
		<#elseif faultHWStatus.cpuStatusList[8] == 2>
			<div class="cpu09 txt cRed">CPU9</div>
		<#else>
			<div class="cpu09 txt cBlack">-</div>
		</#if>	
		
		<#if faultHWStatus.cpuStatusList[9] == 1>
			<div class="cpu10 txt cGreen">CPU10</div>
		<#elseif faultHWStatus.cpuStatusList[9] == 2>
			<div class="cpu10 txt cRed">CPU10</div>
		<#else>
			<div class="cpu10 txt cBlack">-</div>
		</#if>	
		
		<#if faultHWStatus.cpuStatusList[10] == 1>
			<div class="cpu11 txt cGreen">CPU11</div>
		<#elseif faultHWStatus.cpuStatusList[10] == 2>
			<div class="cpu11 txt cRed">CPU11</div>
		<#else>
			<div class="cpu11 txt cBlack">-</div>
		</#if>	
		
		<#if faultHWStatus.cpuStatusList[11] == 1>
			<div class="cpu12 txt cGreen">CPU12</div>
		<#elseif faultHWStatus.cpuStatusList[11] == 2>
			<div class="cpu12 txt cRed">CPU12</div>
		<#else>
			<div class="cpu12 txt cBlack">-</div>
		</#if>	
	<#else>
		<div class="cpu01 txt cBlack">-</div>
		<div class="cpu02 txt cBlack">-</div>
	...
	<#if faultHWStatus.portStatusList?has_content>	
			...
			<tr>
				...
				<td><#if faultHWStatus.portStatusList[28].linkStatus == 1>
						<div class="pFiber1Green"></div>
