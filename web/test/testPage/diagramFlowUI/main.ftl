...
<script type="text/javascript" src="/test/testjs/testDiagramUI.js"></script>

<link rel="stylesheet" href="/test/testcss/mscgen.css" type="text/css" media="screen">
<script data-main="/test/testjs/script/mscgen-main.js" src="/test/testjs/lib/require.js"></script>
...
<script type="text/javascript">
	$(function()
	{
		...
		testDiagramUI = new TestDiagramUI();
		testDiagramUI.loadDiagramFlow();
	});	
</script>
<body>
	<div class="diagramFlow_page">
	</div>
</body>
</html>